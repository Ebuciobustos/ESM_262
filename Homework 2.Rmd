...
dbWriteTable(conn = Parcels, name = "tableP", value = parcels_raw2)

#Whatever you call the table within the connection (i.e. dbWriteTable(conn = XXX, name = tablename, value = your_dataframe)), use that in your SQL code: SELECT columnnames FROM tablename.
...
SELECT columnnames FROM tableP
